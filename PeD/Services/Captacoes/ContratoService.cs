...
namespace PeD.Services.Captacoes
{
    public class ContratoService
    {
        ...
        public static List<Shortcode> ShortcodesRD =
            new List<Shortcode>()
            {
                new Shortcode()
                {
        ...
        public static List<List<string>> GetShortcodesDescriptionsRD()
        {
            return ShortcodesRD.Select(src => new List<string>() {src.Code, src.Label}).ToList();
        }
